      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          <div className="space-y-4">
            ...
            >
              <p className="text-black font-bold">Welcome to PixelCraft Studio</p>
            </motion.div>
            ...
            >
              Building <span className="text-primary">Pixel-Perfect</span> Retro Web Interfaces
            </motion.h1>
            ...
            >
              We design and develop creative web templates with immersive pixel art aesthetics, bringing a nostalgic retro feeling to modern web experiences.
            </motion.p>
          </div>
