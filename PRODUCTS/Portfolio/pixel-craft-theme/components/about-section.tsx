    ...
    <section className="container mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h3 className="text-2xl font-bold">Hi, we are PixelCraft Studio</h3>
          
          <p className="text-lg">
            We are a team of creative developers and designers with a passion for creating unique digital worlds. We specialize in building responsive, blocky, and pixel-perfect websites.
          </p>
          
          <p className="text-lg">
            Our products combine retro gaming aesthetics with modern high-performance frameworks, ensuring your web experience feels nostalgic yet functions flawlessly.
          </p>
