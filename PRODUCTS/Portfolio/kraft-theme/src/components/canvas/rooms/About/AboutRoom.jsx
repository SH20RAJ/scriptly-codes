...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'KRAFT', subtitle: '< creative portfolio />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'AWARDS', subtitle: 'Immersive 3D Experiences • WebGL Showcase' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Crafted with React Three Fiber & GSAP' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Interactive Art • Design Systems • Motion Graphics' },
];
