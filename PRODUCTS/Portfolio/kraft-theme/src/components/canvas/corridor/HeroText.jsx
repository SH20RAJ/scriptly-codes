...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for KRAFT split effect
    const letters = useMemo(() => [
        { char: 'K', baseX: -1.1, splitDir: -1.8, delay: 0 },
        { char: 'R', baseX: -0.55, splitDir: -0.9, delay: 0 },
        { char: 'A', baseX: 0.0, splitDir: 0.0, delay: 0 },
        { char: 'F', baseX: 0.55, splitDir: 0.9, delay: 0 },
        { char: 'T', baseX: 1.1, splitDir: 1.8, delay: 0 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -0.85, splitDir: -1.5, delay: 0 },
        { text: 'creative', baseX: -0.35, splitDir: -0.7, delay: 0 },
        { text: 'portfolio', baseX: 0.35, splitDir: 0.7, delay: 0 },
        { text: '/>', baseX: 0.85, splitDir: 1.5, delay: 0 },
    ], []);
